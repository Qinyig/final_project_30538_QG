...
The Physician Payment Sunshine Act, enacted as part of the Affordable Care Act, was designed to increase transparency in financial relationships between the healthcare industry and medical providers. Through the CMS Open Payments program, pharmaceutical and medical device manufacturers are required to publicly report payments made to physicians and teaching hospitals. This policy intervention rests on the premise that transparency can mitigate conflicts of interest and promote accountability in healthcare decision-making. 

However, transparency alone does not answer deeper structural questions. While the data reveal who receives payments and in what amounts, they do not immediately clarify how industry funding is distributed across clinical specialties, payment types, or geographic regions. Understanding these distributional patterns is essential for evaluating whether industry influence is diffuse and routine, or concentrated and potentially policy-relevant. 

This project moves beyond descriptive transparency to examine the structural and geographic concentration of pharmaceutical industry payments in 2023. By integrating CMS Open Payments data with socio-economic indicators from the American Community Survey (ACS), this analysis explores whether industry payments are aligned with population characteristics or clustered in ways that may have implications for equity and conflict-of-interest oversight. 

## Background

Industry–physician financial relationships take many forms, ranging from small-value food and beverage payments to large royalty or licensing agreements tied to intellectual property. These relationships can support medical innovation, research collaboration, and product development. At the same time, they may raise concerns about potential conflicts of interest, especially when payments are highly concentrated in specific specialties or regions. 

Previous discussions surrounding Open Payments data often focus on total dollar amounts or individual high-profile cases. However, aggregate totals can obscure important structural patterns. For example:

* **Specialty Disparity**: Are payments evenly distributed across medical specialties, or concentrated in device-intensive or procedure-heavy fields? 
* **Structural Origin**: Do high-value payments stem primarily from routine marketing activities or from intellectual property arrangements (e.g., Royalties)? 
* **Economic Clustering**: Are industry payments geographically aligned with population size and need, or disproportionately concentrated in certain economic environments? 

Answering these questions requires combining disaggregated federal payment records with demographic and economic data. By linking CMS General Payments data with ACS state-level income and household indicators, this project constructs normalized measures of payment intensity that allow for meaningful cross-state comparisons. 

## Research Questions

This project addresses three primary research questions to evaluate the landscape of industry influence in 2023:

### 1. Structural Concentration Across Specialties and Payment Types

How are pharmaceutical industry payments distributed across medical specialties and categories of financial transfers?

* Which specialties receive the highest total industry payments? 
* Are total payment dollars concentrated in a small number of high-value payment categories (e.g., royalties and licensing) relative to routine transaction types? 
* This question examines whether industry influence is structurally concentrated within particular clinical and financial ecosystems. 


### 2. Geographic Distribution and Payment Intensity

When normalized by population size or number of households, how do industry payments vary across states?

* Which states exhibit the highest payment intensity per household? 
* Do spatial clusters of industry funding emerge beyond what would be expected from population differences alone? 


### 3. Socio-economic Alignment

Is there a relationship between regional economic conditions and industry payment intensity?

* Is median household income statistically associated with industry payment per household? 
* Do higher-income states receive systematically greater industry funding? 
* This question explores whether industry financial relationships align with wealth patterns, which may have implications for how industry influence is distributed across different economic environments. 
...
Policy Implications
The findings of this study move beyond simple transparency, suggesting that the current oversight framework under the Sunshine Act may need to evolve to address structural and geographic inequalities.

1. Targeted Audit Strategies
The discovery of the "1% Rule"—where 66% of total funding is captured by a minute fraction of recipients—indicates that conflict-of-interest (COI) risks are not uniformly distributed.

Recommendation: Regulators should adopt a risk-based auditing approach. Instead of broad, descriptive oversight, resources should be prioritized for the top 1% of recipients, particularly those involved in high-value Royalty and Licensing agreements, as their financial ties have the highest potential for systemic influence on clinical guidelines.

2. Specialty-Specific Transparency Frameworks
Our analysis reveals that industry influence operates differently across clinical ecosystems (e.g., high-stakes device bonding in Orthopaedics vs. high-frequency marketing in Internal Medicine).

Recommendation: Disclosure requirements should be tailored to the nature of the specialty. For device-intensive fields, more granular reporting on the relationship between intellectual property payments and clinical adoption of specific medical devices is necessary.

3. Addressing "Resource Deserts" and Geographic Equity
The Wealth Alignment effect demonstrates that industry capital systematically flows to affluent regions (such as PA and MA), potentially leaving low-income populations in "resource deserts" with less access to medical innovation and industry-sponsored clinical education.

Recommendation: Public health agencies should consider incentives to encourage industry-physician collaborations in underserved or low-income regions. Furthermore, state-level transparency initiatives should be intensified in "high-intensity" zones to monitor the concentration of industry influence in wealthy medical hubs.

4. Enhancing Public Data Utility
The sheer volume of CMS data can act as a "barrier by complexity."

Recommendation: To fulfill the Sunshine Act’s original promise of accountability, the government should invest in interactive, user-facing analytical tools—similar to the dashboard developed in this project. Providing patients and researchers with the ability to visualize structural patterns (rather than just viewing raw lists of names) is essential for effective public scrutiny.